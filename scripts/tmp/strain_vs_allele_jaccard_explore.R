...
min_num_features <- 3
jaccard_summary <- jaccard_summary[which(jaccard_summary$num_samples >= min_num_features & jaccard_summary$num_alleles >= min_num_features & jaccard_summary$num_strainfacts_strains >= min_num_features & jaccard_summary$num_straingst_strains >= min_num_features), ]
