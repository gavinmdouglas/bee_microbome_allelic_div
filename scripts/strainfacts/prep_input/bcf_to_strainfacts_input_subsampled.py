...
def main():
    ...
    python bcfs_to_strainfacts_input_subsampled.py --input INPUT
                                                   --bed BED
                                                   --outdir OUTDIR
                                                   --subsample 50
                                                   --random_seed 1
    ...
    for gene in sorted(gene_info.keys()):
        ...
        # First exclude all samples without at least min_depth reads at > 90% of sites for this gene.
        ...
        # Then exclude all sites that don't have at least min_depth reads across > 90% of these samples.
