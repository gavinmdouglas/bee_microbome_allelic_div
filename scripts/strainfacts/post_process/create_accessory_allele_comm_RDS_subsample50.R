...
centroid_comms <- read.table(file = '/scratch/gdouglas/projects/honey_bee/strainfacts_working/accessory_out_subsampled_processed/subsample50/centroid_rep_comm_files.txt',
...
saveRDS(object = allele_relabun,
        file = "/scratch/gdouglas/projects/honey_bee/strainfacts_working/accessory_out_subsampled_processed/subsample50/strainfacts_accessory_allele_relabun.rds")
