...
comm_file_path <- '/scratch/gdouglas/projects/honey_bee/strainfacts_working/accessory_out_subsampled/subsample50/comm'
prepped_path <- '/scratch/gdouglas/projects/honey_bee/strainfacts_working/prepped_input/prepped_accessory_input_subsampled'
...
write.table(x = centroid_replicate_files,
            file = '/scratch/gdouglas/projects/honey_bee/strainfacts_working/accessory_out_subsampled_processed/subsample50/centroid_rep_comm_files.txt',
